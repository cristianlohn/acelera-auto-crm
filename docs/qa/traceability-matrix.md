...
| **REQ-CRM-05** | **CT-UT-02** | Formatar valores numéricos decimais ou com zero para o padrão BRL (`R$ 0,00`). | Unitário | Análise de Valor Limite (BVA) | `formatters-and-rules.test.ts` | **PASS** |
