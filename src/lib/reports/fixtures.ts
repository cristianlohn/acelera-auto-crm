...
export const PERIOD_METRICS: Record<ReportPeriod, ExecutiveReportData> = {
  "7d": {
    ...
    funnel: [
      ...
      { id: "perdido", name: "Perdido", count: 1, percentage: 13, conversionFromPrev: 50.0 },
    ],
    channels: [
    ...
    sellers: [
      { id: "sp-001", name: "Rafael Martins", avatar: "RM", dealsCount: 1, revenue: 152000, avgResponseMinutes: 10, conversionRate: 20.0 },
      { id: "sp-002", name: "Amanda Souza", avatar: "AS", dealsCount: 0, revenue: 0, avgResponseMinutes: 8, conversionRate: 0.0, pipelineValue: 506500 },
      { id: "sp-003", name: "Lucas Ferreira", avatar: "LF", dealsCount: 0, revenue: 0, avgResponseMinutes: 0, conversionRate: 0.0, pipelineValue: 0 },
    ],
    topVehicles: [
  ...
  quarter: {
    ...
    sellers: [
      { id: "sp-001", name: "Rafael Martins", avatar: "RM", dealsCount: 31, revenue: 3120000, avgResponseMinutes: 11, conversionRate: 21.5 },
      { id: "sp-002", name: "Amanda Souza", avatar: "AS", dealsCount: 20, revenue: 2050000, avgResponseMinutes: 9, conversionRate: 17.2 },
      { id: "sp-003", name: "Lucas Ferreira", avatar: "LF", dealsCount: 3, revenue: 250000, avgResponseMinutes: 15, conversionRate: 8.5 },
    ],
    topVehicles: [
  ...
  year: {
    ...
    sellers: [
      { id: "sp-001", name: "Rafael Martins", avatar: "RM", dealsCount: 120, revenue: 11200000, avgResponseMinutes: 10, conversionRate: 23.8 },
      { id: "sp-002", name: "Amanda Souza", avatar: "AS", dealsCount: 82, revenue: 7450000, avgResponseMinutes: 8, conversionRate: 18.5 },
      { id: "sp-003", name: "Lucas Ferreira", avatar: "LF", dealsCount: 16, revenue: 1150000, avgResponseMinutes: 14, conversionRate: 10.2 },
    ],
    topVehicles: [
