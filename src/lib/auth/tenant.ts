...
export async function resolveUserTenantContext(): Promise<TenantContextResult> {
  ...
  if (isTestAuth) {
    return {
      isDemo: false,
      userId: "roberto-silva-user-id",
      userEmail: "roberto.silva@autoprime.com.br",
      organizationId: "org-auto-prime-id",
      profile: {
        id: "roberto-silva-user-id",
        organization_id: "org-auto-prime-id",
      ...
      organization: {
        id: "org-auto-prime-id",
        name: "Auto Prime Veículos",
        slug: "auto-prime-veiculos",
        plan: "pro",
