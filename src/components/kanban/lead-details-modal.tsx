...
export function LeadDetailsModal({
  ...
  return (
    ...
    >
      ...
      {/* Conteúdo do Modal */}
      <div className="relative w-full max-w-2xl max-h-[90vh] flex flex-col rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-zinc-950 text-slate-900 dark:text-slate-100 shadow-2xl overflow-hidden z-10">
        {/* Cabeçalho do Modal */}
        <div className="flex items-start justify-between border-b border-slate-200 dark:border-slate-800/80 p-5 bg-slate-50/50 dark:bg-zinc-900/50">
          <div className="flex items-center gap-3.5 min-w-0">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-500 to-red-600 text-base font-extrabold text-white shadow-md shadow-orange-500/20">
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-5 custom-scrollbar">
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-800/80 bg-slate-50 dark:bg-zinc-900/70 p-3.5 space-y-2.5">
              ...
              {KANBAN_STAGES_CONFIG.map((stage) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "flex items-center justify-between rounded-lg px-2.5 py-1.5 text-xs font-medium border transition-all text-left",
                      isActive
                        ? "bg-gradient-to-r from-orange-500 to-red-600 text-white border-transparent shadow-sm font-semibold ring-1 ring-orange-500"
