    ...
    >
      ...
      {onAddLeadClick && column.id === "new" && (
        <button
          ...
          className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl border border-dashed border-white/10 py-2 text-xs font-semibold text-zinc-400 hover:border-orange-500/40 hover:bg-orange-500/5 hover:text-orange-400 transition-all"
        >
          <Plus className="h-3.5 w-3.5" />
          <span>Novo Lead</span>
        </button>
