...
const plans: Plan[] = [
  {
    ...
    monthlyPrice: 297,
    annualPrice: 2970,
    sellersLimit: "Até 3 vendedores inclusos na Roleta",
    features: [
      "Até 3 vendedores inclusos na Roleta",
      "Motor de Ingestão de Leads (Meta Ads, Webmotors, iCarros via API Key)",
      "Distribuição Fair Round-Robin por ordem de espera",
      "Funil Kanban com cronômetro de SLA e link WhatsApp 1-clique",
      "Gestão de Clientes e Estoque de Veículos",
  ...
  },
  {
    ...
    monthlyPrice: 597,
    annualPrice: 5970,
    sellersLimit: "Até 8 vendedores inclusos na Roleta",
    features: [
      "Todos os recursos do Starter +",
      "Até 8 vendedores inclusos na Roleta",
      "Roleta com Especialização por Segmento (Novos 0km, Seminovos e F&I)",
      "Cockpit do Gestor com Auditoria de Leads e Perda de Oportunidades",
      "Acompanhamento de Metas Comerciais e Pausa de Plantão em tempo real",
      "Suporte Prioritário",
    ],
  },
  {
    ...
    monthlyPrice: 1297,
    annualPrice: 12970,
    sellersLimit: "Vendedores ilimitados na Roleta",
    features: [
      "Todos os recursos do Pro +",
      "Vendedores ilimitados na Roleta",
      "Múltiplas Chaves de API para portais e campanhas",
      "Onboarding guiado com treinamento ao vivo da equipe",
      "Atendimento VIP com SLA dedicado",
    ],
  },
];
